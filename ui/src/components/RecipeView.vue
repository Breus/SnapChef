        ...
        <div class="mx-auto max-w-3xl px-2 sm:px-6 lg:px-8">
            ...
            <div v-else-if="!showLoading && recipe" class="overflow-hidden rounded-lg bg-white shadow-lg">
                ...
                <div class="border-b border-gray-300 px-4 sm:px-6 pt-6 sm:pt-8 pb-6">
                        ...
                        <div class="flex items-center space-x-2 flex-shrink-0">
                            <button @click="clickFavoriteRecipe"
                                ...
                                <svg v-else xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                     ...
                                     class="w-5 h-5 text-gray-500 hover:text-green-600 transition-colors duration-150">
                            ...
                            <button v-if="recipe && recipe.author && recipe.author.userId == userId" @click="deleteRecipe"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="1.5"
                                     stroke="currentColor"
                                     class="w-5 h-5 text-gray-500 hover:text-red-600 transition-colors duration-150">
                                    <path fill="none" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <!-- Title for Mobile -->
                    <h1 class="block md:hidden mb-3 text-2xl sm:text-3xl font-bold text-gray-900">
                        {{ recipe?.title }}
                    </h1>
