...
INSERT INTO recipe (title, description, num_servings, preparation_time, author_id) VALUES
  ('Spaghetti Bolognese', 'Classic Italian pasta dish.', 4, 'MIN_0_15', 1),
  ...
  ('Banana Bread', 'Moist and delicious homemade bread.', 4, 'MIN_15_30', 2),
  ('Vegetable Soup', 'Healthy and warming soup with mixed vegetables.', 4, 'MIN_15_30', 3)
...
INSERT INTO user_favorite_recipe (user_account_id, recipe_id) VALUES
  (1, 1),
  (1, 2),
  (2, 1),
  (2, 2)
